...
namespace Acelera.Testes.ConjuntoArquivos
{
    ...
    {
        public TriplicePOMPEIA(int quantidadeCliente, IMyLogger logger, ref AlteracoesArquivo alteracoesArquivo) : base(quantidadeCliente, logger,ref alteracoesArquivo)
        {
