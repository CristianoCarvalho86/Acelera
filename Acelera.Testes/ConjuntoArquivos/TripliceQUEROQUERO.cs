...
namespace Acelera.Testes.ConjuntoArquivos
{
    ...
    {
        public TripliceQUEROQUERO(int quantidadeCliente, IMyLogger logger, ref AlteracoesArquivo alteracoesArquivo) : base(quantidadeCliente, logger,ref alteracoesArquivo)
        {
