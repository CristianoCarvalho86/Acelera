...
namespace Acelera.Testes.ConjuntoArquivos
{
    ...
    {
        public TriplicePITZI(int quantidadeCliente, IMyLogger logger, ref AlteracoesArquivo alteracoesArquivo) : base(quantidadeCliente, logger, ref alteracoesArquivo)
        {
