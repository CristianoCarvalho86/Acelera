...
Cancelamento deve ser do tipo com restituição (Cd_MOVTO_COBRANÇA=02)"
        ...
        public void Teste7()
        {
            ...
            EnviarCancelamento<Arquivo_Layout_9_4_ParcEmissao, Arquivo_Layout_9_4_EmsComissao>(arquivo.ObterLinha(0), OperadoraEnum.SOFTBOX, "10", false, "4");
            /*
...
//            arquivo = EnviarEmissao<Arquivo_Layout_9_3_EmsComissao>(OperadoraEnum.VIVO);
//            EnviarCancelamento<Arquivo_Layout_9_3_EmsComissao>(arquivo.ObterLinha(0), OperadoraEnum.VIVO, "9");
//            EnviarCancelamento<Arquivo_Layout_9_3_EmsComissao>(arquivo.ObterLinha(0), OperadoraEnum.VIVO, "9");
...
//        }
        ...
        public void EnviarCancelamento<T,C>(LinhaArquivo linhaArquivoEmissao, OperadoraEnum operadora, string cdTipoEmissao, bool alterarLayout = false, string nrSequencialEmissao = "") where T : Arquivo, new() where C : Arquivo, new()
        {
