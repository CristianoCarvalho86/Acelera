...
{
    public static class ODSInsertComissaoCancelamentoData
    {
        public static string InsertText(string dadosWhere)
        {
            return "insert into TAB_ODS_COMISSAO_2006(" +
" CD_COMISSAO," +
" CD_PARCELA," +
" CD_PN_CORRETOR ," +
" CD_TIPO_COMISSAO," +
...
" )" +
" select" +
" SEQ_ODS_COMISSAO_2006.nextval AS CD_COMISSAO," +
" PARCODS.CD_PARCELA," +
...
" A.TP_MUDANCA; ";
        ...
        public static void Insert(string idRegistro, IMyLogger logger)
        {
            ...
            if (count1 == count2)
            {
                ...
                throw new Exception("NENHUMA LINHA INSERIDA NA ODS COMISSAO CANCELAMENTO PARA O ID_REGISTRO: " + idRegistro);
            }
        }
    }
}
