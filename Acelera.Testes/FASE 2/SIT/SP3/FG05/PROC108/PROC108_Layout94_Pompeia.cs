...
{
    [TestClass]
    public class PROC108_Layout93_POMPEIA : TestesFG05
    {
        ...
        public void SAP_4497()
        {
            ...
            AlterarLinha(0, "CD_CONTRATO", StringUtils.AlterarUltimasPosicoes(ObterValorFormatado(0, "CD_CONTRATO"),"00001"));
        ...
        public void SAP_4498()
        {
            IniciarTeste(TipoArquivo.Comissao, "4498", "FG05 - PROC108");
