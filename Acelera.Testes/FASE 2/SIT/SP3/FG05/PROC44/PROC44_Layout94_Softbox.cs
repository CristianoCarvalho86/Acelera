...
{
    [TestClass]
    public class PROC44_Layout94_SOFTBOX : TestesFG05
    {
        ...
        public void SAP_4378()
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "4378", "FG05 - PROC44 - ");
        ...
        [TestMethod]
        [TestCategory("Com Critica")]
        public void SAP_4379()
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "4379", "FG05 - PROC44 - ");


            //Envia parc normal
            var arquivoods1 = new Arquivo_Layout_9_4_ParcEmissao();
            CarregarArquivo(arquivoods1, 1, OperadoraEnum.SOFTBOX);
            ...
            CarregarArquivo(arquivoods2, 1, OperadoraEnum.SOFTBOX);
        ...
        public void SAP_4380()
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "4380", "FG05 - PROC44 - ");
        ...
        [TestMethod]
        [TestCategory("Sem Critica")]
        public void SAP_4381()
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "4381", "FG05 - PROC44 - ");
