...
{
    [TestClass]
    public class PROC220_Layout94_LASA : TestesFG05
    {
        ...
        public void SAP_4611()
        {
            IniciarTeste(TipoArquivo.OCRCobranca, "4611", "FG05 - PROC220 - ");
        ...
        public void SAP_4613()
        {
            IniciarTeste(TipoArquivo.OCRCobranca, "4613", "FG05 - PROC220 - ");
            ...
            CarregarArquivo(arquivoods3, 1, OperadoraEnum.LASA);
