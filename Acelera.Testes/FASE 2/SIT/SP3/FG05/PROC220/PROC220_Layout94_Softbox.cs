...
{
    [TestClass]
    public class PROC220_Layout94_SOFTBOX : TestesFG05
    {
        ...
        public void SAP_4615()
        {
            IniciarTeste(TipoArquivo.OCRCobranca, "4615", "FG05 - PROC220 - ");
        ...
        public void SAP_4617()
        {
            IniciarTeste(TipoArquivo.OCRCobranca, "4617", "FG05 - PROC220 - ");
            ...
            CarregarArquivo(arquivoods3, 1, OperadoraEnum.SOFTBOX);
