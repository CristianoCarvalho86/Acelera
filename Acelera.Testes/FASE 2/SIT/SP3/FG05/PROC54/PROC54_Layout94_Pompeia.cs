...
{
    [TestClass]
    public class PROC54_Layout94_POMPEIA : TestesFG05
    {
        /// <summary>
        ...
        public void SAP_4407()
        {
            IniciarTeste(TipoArquivo.Comissao, "4407", "FG05 - PROC54");
        ...
        [TestMethod]
        [TestCategory("Com Critica")]
        public void SAP_4408()
        {
            IniciarTeste(TipoArquivo.Comissao, "4408", "FG05 - PROC54");
        ...
        [TestMethod]
        [TestCategory("Com Critica")]
        public void SAP_4409()
        {
            IniciarTeste(TipoArquivo.Comissao, "4409", "FG05 - PROC54");
        ...
        [TestMethod]
        [TestCategory("Com Critica")]
        public void SAP_4410()
        {
            IniciarTeste(TipoArquivo.Comissao, "4410", "FG05 - PROC54");
        ...
        [TestMethod]
        [TestCategory("Com Critica")]
        public void SAP_4411()
        {
            IniciarTeste(TipoArquivo.Comissao, "4411", "FG05 - PROC54");
        ...
        [TestMethod]
        [TestCategory("Com Critica")]
        public void SAP_4412()
        {
            IniciarTeste(TipoArquivo.Comissao, "4412", "FG05 - PROC54");
        ...
        public void SAP_4413()
        {
            IniciarTeste(TipoArquivo.Comissao, "4413", "FG05 - PROC54");
