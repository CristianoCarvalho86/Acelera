...
namespace Acelera.Testes.FASE_2.SIT.SP4.FG09.PROC190
{
    ...
    public class PROC190_LAYOUT94_TIM : TestesFG09
    {
        ...
        public void SAP_5479()
        {
            ...
            //Envia parc normal
            var arquivoods = CriarEmissaoODS<Arquivo_Layout_9_4_ParcEmissao>(OperadoraEnum.TIM, false, "20", 2);
        ...
        public void SAP_5480()
        {
            ...
            //Envia parc normal
            var arquivoods = CriarEmissaoODS<Arquivo_Layout_9_4_ParcEmissao>(OperadoraEnum.TIM, false, "20", 3);
