...
{
    [TestClass]
    public class PROC206_LAYOUT94_POMPEIA : TestesFG09
    {
        private OperadoraEnum operacaoDoTeste => OperadoraEnum.POMPEIA;

        [TestMethod]
        [TestCategory("Com Critica")]
        public void SAP_5675()
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "5675", "FG09 - PROC206 - ");
        ...
        [TestMethod]
        [TestCategory("Com Critica")]
        public void SAP_5676()
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "5676", "FG09 - PROC206 - ");
        ...
        [TestMethod]
        [TestCategory("Com Critica")]
        public void SAP_5677()
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "5677", "FG09 - PROC206 - ");
        ...
        public void SAP_5678()
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "5678", "FG09 - PROC206 - ");
        ...
        [TestMethod]
        [TestCategory("Sem Critica")]
        public void SAP_5679()
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "5679", "FG09 - PROC206 - ");
