...
{
    [TestClass]
    public class PROC211_LAYOUT94_POMPEIA : TestesFG09
    {
        private OperadoraEnum operacaoDoTeste => OperadoraEnum.POMPEIA;

        [TestMethod]
        [TestCategory("Com Critica")]
        public void SAP_5726()
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "5726", "FG09 - PROC211 - ");
        ...
        public void SAP_5727()
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "5727", "FG09 - PROC211 - ");
