...
namespace Acelera.Testes.FASE_2.SIT.SP2.FG02
{
    ...
    public class PROC120_Layout93_VIVO : TestesFG02
    {
        ...
        /// <summary>
        /// Informar CD_TIPO_MOVIMENTO =7 e Informar CD_FORMA_PAGTO=20
        /// </summary>
        [TestMethod]
        [TestCategory("Com Critica")]
        public void SAP_3017_CD_FORMA_PAGTO_inv()
        {
        ...
        /// <summary>
        /// Informar CD_TIPO_MOVIMENTO =146 e Informar CD_FORMA_PAGTO=25
        /// </summary>
        [TestMethod]
        [TestCategory("Com Critica")]
        public void SAP_3018_CD_FORMA_PAGTO()
        {
            IniciarTeste(TipoArquivo.Sinistro, "3018", "FG02 - PROC88 - Informar CD_TIPO_MOVIMENTO =146 e Informar CD_FORMA_PAGTO=25");
            arquivo = new Arquivo_Layout_9_3_Sinistro();
            arquivo.Carregar(ObterArquivoOrigem("C01.VIVO.SINISTRO-EV-000001-20200206.txt"));

            //ALTERAR O VALOR SELECIONADO
            AlterarLinha(0, "CD_TIPO_MOVIMENTO", "146");
            AlterarLinha(0, "CD_FORMA_PAGTO", "25");
        ...
        /// <summary>
        /// Informar CD_TIPO_MOVIMENTO =7 e Informar CD_FORMA_PAGTO=6
        /// </summary>
        [TestMethod]
        [TestCategory("Sem Critica")]
        public void SAP_3024_SINISTRO_semcritica()
        {
            IniciarTeste(TipoArquivo.Sinistro, "3024", "Informar CD_TIPO_MOVIMENTO =7 e Informar CD_FORMA_PAGTO=6");
        ...
        /// <summary>
        /// Informar CD_TIPO_MOVIMENTO =146 e Informar CD_FORMA_PAGTO=7
        /// </summary>
        [TestMethod]
        [TestCategory("Sem Critica")]
        public void SAP_3025_SINISTRO_semcritica()
        {
            IniciarTeste(TipoArquivo.Sinistro, "3025", "Informar CD_TIPO_MOVIMENTO =146 e Informar CD_FORMA_PAGTO=7");
