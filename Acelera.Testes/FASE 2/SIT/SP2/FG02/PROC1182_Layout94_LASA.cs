...
namespace Acelera.Testes.FASE_2.SIT.SP2.FG02
{
    ...
    public class PROC1182_Layout94_LASA : TestesFG02
    {
        ...
        [TestMethod]
        [TestCategory("Sem Critica")]
        public void SAP_4148_ParcEmissao_semcritica()
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "4148", "FG02 - PROC1182 - Informar VL_DESCONTO igual ao valor mínimo de desconto parametrizado na tabela TAB_PRM_PERCENT_PREMIO_7012 ");
        ...
        [TestMethod]
        [TestCategory("Sem Critica")]
        public void SAP_4149_ParcEmissao_semcritica()
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "4149", "FG02 - PROC1182 - Informar VL_DESCONTO igual ao valor máximo de desconto parametrizado na tabela TAB_PRM_PERCENT_PREMIO_7012 ");
