...
namespace Acelera.Testes.FASE_2.SIT.SP2.FG02
{
    ...
    public class PROC1184_Layout94_LASA : TestesFG02
    {
        ...
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "3940", "FG02 - PROC1184 - Informar VL_ADIC_FRACIONADO  superior ao valor máximo de desconto parametrizado na tabela TAB_PRM_PERCENT_PREMIO_7012");
        ...
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "3941", "FG02 - PROC1184 - Informar VL_ADIC_FRACIONADO  inferior ao valor mínimo de desconto parametrizado na tabela TAB_PRM_PERCENT_PREMIO_7012");
            arquivo = new Arquivo_Layout_9_4_ParcEmissao();
        ...
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "3942", "FG02 - PROC1184 - Informar VL_ADIC_FRACIONADO  compreendido entre o valor mínimo e máximo do desconto parametrizado na tabela TAB_PRM_PERCENT_PREMIO_7012");
