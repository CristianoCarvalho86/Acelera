...
namespace Acelera.Testes.FASE_2.SIT.SP2.FG02
{
    ...
    public class PROC33_Layout94_LASA : TestesFG02
    {
        ...
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "2799", "FG02 - PROC33 - Enviar 1 arquivo com CD_TIPO_EMISSAO=1; CD_ENDOSSO=0 e NR_SEQ_EMISSAO=1. Em seguida, enviar outro arquivo, com CD_TIPO_EMISSAO=20, NR_ENDOSSO diferente de 0 e NR_SEQ_EMISSAO=2");
