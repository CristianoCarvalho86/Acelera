...
namespace Acelera.Testes.FASE_2.SIT.SP2.FG02
{
    ...
    public class PROC11_Layout93_VIVO : TestesFG02
    {
        ...
        {
            IniciarTeste(TipoArquivo.Cliente, "2655", "FG02 - PROC11 - Informar no arquivo PARC_EMISSAO_AUTO o campo dt_fim_vigencia 10 dias menor que o dt_inicio_vigencia");
