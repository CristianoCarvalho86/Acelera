...
namespace Acelera.Testes.FASE_2.SIT.SP2.FG02
{
    ...
    public class PROC1184_Layout94_Softbox : TestesFG02
    {
        ...
        [TestMethod]
        [TestCategory("Sem Critica")]
        public void SAP_4160_ParcEmissao_semcritica()
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "4160", "FG02 - PROC1184 - Informar VL_ADIC_FRACIONADO igual ao valor mínimo de desconto parametrizado na tabela TAB_PRM_PERCENT_PREMIO_7012 ");
