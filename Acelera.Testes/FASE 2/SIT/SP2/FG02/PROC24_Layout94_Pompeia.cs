...
namespace Acelera.Testes.FASE_2.SIT.SP2.FG02
{
    ...
    public class PROC24_Layout94_Pompeia : TestesFG02
    {
        ...
        public void SAP_2748_PARC_EMISSAO_CD_COBERTURA_Inv()
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "2748", "FG02 - PROC24 - Informar no campo CD_COBERTURA valor diferente do parametrizado na tabela TAB_PRM_COBERTURA_7007");
