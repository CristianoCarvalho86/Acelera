...
namespace Acelera.Testes.FASE_2.SIT.SP2.FG02
{
    ...
    public class PROC1191_Layout94_LASA : TestesFG02
    {
        ...
        {
            IniciarTeste(TipoArquivo.LanctoComissao, "3957", "FG02 - PROC1191 - Informar CD_EXTRATO_COMISSAO = 4");
        ...
        {
            IniciarTeste(TipoArquivo.LanctoComissao, "3958", "FG02 - PROC1191 - Informar CD_EXTRATO_COMISSAO = 1");
            ...
            //VALIDAR NA FG01
            ValidarLogProcessamento(true);
            ValidarTabelaDeRetorno(true, "1191");
