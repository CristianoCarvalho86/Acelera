...
{
    [TestClass]
    public class PROC218_Layout94_PITZI : TestesFG02
    {
        ...
        public void SAP_3750_VL_PREMIO_TOTAL_inv()
        {
            ...
            arquivo = new Arquivo_Layout_9_4_EmsComissao();
            arquivo.Carregar(ObterArquivoOrigem("C01.PITZI.EMSCMS-EV-1935-20200213.txt"));
        ...
        public void SAP_3751_VL_PREMIO_TOTAL_inv()
        {
            ...
            arquivo = new Arquivo_Layout_9_4_EmsComissao();
            arquivo.Carregar(ObterArquivoOrigem("C01.PITZI.EMSCMS-EV-1929-20200211.txt"));
        ...
        public void SAP_3754_SEM_CRITICA()
        {
            ...
            arquivo = new Arquivo_Layout_9_4_EmsComissao();
            arquivo.Carregar(ObterArquivoOrigem("C01.PITZI.EMSCMS-EV-1917-20200207.txt"));
