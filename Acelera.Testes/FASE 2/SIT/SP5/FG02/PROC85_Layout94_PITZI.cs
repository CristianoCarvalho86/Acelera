...
{
    [TestClass]
    public class PROC85_Layout94_PITZI : TestesFG02
    {

        /// <summary>
        /// Informar CD_TIPO_MOVIMENTO =7, TP_SINISTRO=04, CD_FORMA_PAGTO=D e não informar campo CD_BANCO_SEG
        /// </summary>
        [TestMethod]
        [TestCategory("Com Critica")]
        public void SAP_2868_SemCD_BANCO_SEG()
        {
            IniciarTeste(TipoArquivo.Sinistro, "2868", "FG02 - PROC85 - Informar CD_TIPO_MOVIMENTO =7, TP_SINISTRO=04, CD_FORMA_PAGTO=D e não informar campo CD_BANCO_SEG");
            arquivo = new Arquivo_Layout_9_4_Sinistro();
            arquivo.Carregar(ObterArquivoOrigem("C01.PITZI.SINISTRO-EV-0002-20191220.txt"));
            ...
            SalvarArquivo($"C01.PITZI.SINISTRO-EV-/*R*/-20191220.txt");
        ...
        /// <summary>
        /// Informar CD_TIPO_MOVIMENTO =7, TP_SINISTRO=04, CD_FORMA_PAGTO=D e informar CD_BANCO_SEG
        /// </summary>
        [TestMethod]
