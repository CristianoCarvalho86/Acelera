...
{
    [TestClass]
    public class PROC223_Layout94_PITZI : TestesFG02
    {
        ...
        public void SAP_3776_PARC_EMISSAO_semcritica()
        {
            ...
            //CARREGAR O ARQUIVO BASE
            arquivo = new Arquivo_Layout_9_4_ParcEmissao();
            arquivo.Carregar(ObterArquivoOrigem("C01.PITZI.PARCEMS-EV-1934-20200213.txt"));
            ...
            //SALVAR O NOVO ARQUIVO ALTERADO
            SalvarArquivo($"C01.PITZI.PARCEMS-EV-/*R*/-20200213.txt");
