...
{
    [TestClass]
    public class PROC124_Layout94_PITZI : TestesFG02
    {
        ...
        public void SAP_4139_DT_OCORRENCIA_inv()
        {
            ...
            arquivo.Carregar(ObterArquivoOrigem("C01.PITZI.COBRANCA-EV-1694-20191128.txt"));
        ...
        public void SAP_4140_OCRCobranca_semcritica()
        {
            ...
            arquivo = new Arquivo_Layout_9_4_OcrCobranca();
            arquivo.Carregar(ObterArquivoOrigem("C01.PITZI.COBRANCA-EV-1695-20191128.txt"));
        ...
        public void SAP_4141_OCRCobranca_semcritica()
        {
            ...
            arquivo = new Arquivo_Layout_9_4_OcrCobranca();
            arquivo.Carregar(ObterArquivoOrigem("C01.PITZI.COBRANCA-EV-1766-20191220.txt"));
