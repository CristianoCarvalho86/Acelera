...
{
    [TestClass]
    public class PROC124_Layout94_PAPCARD : TestesFG02
    {
        ...
        public void SAP_4139_DT_OCORRENCIA_inv()
        {
            ...
            arquivo.Carregar(ObterArquivoOrigem("C01.PAPCARD.COBRANCA-EV-1694-20191128.txt"));
        ...
        public void SAP_4141_OCRCobranca_semcritica()
        {
            ...
            arquivo = new Arquivo_Layout_9_4_OcrCobranca();
            arquivo.Carregar(ObterArquivoOrigem("C01.PAPCARD.COBRANCA-EV-1766-20191220.txt"));
