...
{
    [TestClass]
    public class PROC107_Layout94_COOP : TestesFG02
    {
        ...
        public void SAP_2911_COB_RAMO_PROD_NAO_ASSOCIADOS()
        {
            ...
            arquivo.Carregar(ObterArquivoOrigem("C01.COOP.SINISTRO-EV-0001-20191128.txt"));
        ...
        public void SAP_2912_SEM_CRITICA()
        {
            ...
            arquivo = new Arquivo_Layout_9_4_ParcEmissao();
            arquivo.Carregar(ObterArquivoOrigem("C01.COOP.PARCEMS-EV-1982-20200302.txt"));
            ...
            //SALVAR O NOVO ARQUIVO ALTERADO
            SalvarArquivo($"C01.COOP.PARCEMS-EV-/*R*/-20200302.txt");
