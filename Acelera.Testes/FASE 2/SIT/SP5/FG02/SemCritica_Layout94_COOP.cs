...
{
    [TestClass]
    public class SemCritica_Layout94_COOP : TestesFG02
    {
        ...
        public void SAP_4724_SemCritica_COBRANCA()
        {
            ...
            arquivo.Carregar(ObterArquivoOrigem("C01.COOP.COBRANCA-EV-1769-20191220.txt"));
        ...
        public void SAP_4715_SemCritica_COMISSAO()
        {
            ...
            arquivo.Carregar(ObterArquivoOrigem("C01.COOP.EMSCMS-EV-1929-20200211.txt"));
