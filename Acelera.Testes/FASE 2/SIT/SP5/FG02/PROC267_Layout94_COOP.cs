...
{
    [TestClass]
    public class PROC267_Layout94_COOP : TestesFG02
    {
        ...
        public void SAP_3786_CANC_Inv()
        {
            ...
            arquivo.Carregar(ObterArquivoOrigem("C01.COOP.CLIENTE-EV-1930-20200212.txt"));

            //ALTERAR O VALOR SELECIONADO
            AlterarLinha(1, "DT_NASCIMENTO", "20030416");

            //SALVAR O NOVO ARQUIVO ALTERADO
            SalvarArquivo($"C01.COOP.CLIENTE-EV-/*R*/-20200212.txt");
        ...
        public void SAP_3787_PARC_EMISSAO_semcritica()
        {
            ...
            arquivo = new Arquivo_Layout_9_4_Cliente();
            arquivo.Carregar(ObterArquivoOrigem("C01.COOP.CLIENTE-EV-1927-20200211.txt"));

            //ALTERAR O VALOR SELECIONADO
            AlterarLinha(1, "DT_NASCIMENTO", "20020416");

            //SALVAR O NOVO ARQUIVO ALTERADO
            SalvarArquivo($"C01.COOP.CLIENTE-EV-/*R*/-20200211.txt");
        ...
        public void SAP_3788_PARC_EMISSAO_semcritica()
        {
            ...
            //CARREGAR O ARQUIVO BASE
            arquivo = new Arquivo_Layout_9_4_Cliente();
            arquivo.Carregar(ObterArquivoOrigem("C01.COOP.CLIENTE-EV-1924-20200210.txt"));

            //ALTERAR O VALOR SELECIONADO
            AlterarLinha(1, "DT_NASCIMENTO", "20010416");

            //SALVAR O NOVO ARQUIVO ALTERADO
            SalvarArquivo($"C01.COOP.CLIENTE-EV-/*R*/-20200210.txt");
