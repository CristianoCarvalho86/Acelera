...
{
    [TestClass]
    public class PROC05_Layout96_PAPCARD : TestesFG01
    {
        ...
        public void SAP_8151_CLIENTE_SemCampObrig_Body()
        {
            IniciarTeste(TipoArquivo.Cliente, "", "FG01 - PROC5 - No Body do arquivo CLIENTE não informar valor nos seguintes campos: EN_BAIRRO EN_CIDADE EN_UF EN_CEP EN_PAIS TIPO SEXO DT_NASCIMENTO");
        ...
        [TestMethod]
        [TestCategory("Com Critica")]
        public void SAP_8152_PARC_EMISSAO_SemCampObrig_Body()
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "", "FG01 - PROC5 - No Body do arquivo PARC_EMISSAO não informar valor nos seguintes campos: DT_REFERENCIA NR_PROPOSTA DT_PROPOSTA DT_EMISSAO DT_INICIO_VIGENCIA DT_FIM_VIGENCIA NR_APOLICE NR_ENDOSSO NR_DOCUMENTO DT_VENCIMENTO VL_PREMIO_LIQUIDO VL_IOF VL_PREMIO_TOTAL VL_TAXA_MOEDA CD_STATUS_EMISSAO VL_IS VL_FRANQUIA CD_PRODUTO ID_TRANSACAO CD_UF_RISCO");
        ...
        [TestMethod]
        [TestCategory("Com Critica")]
        public void SAP_8153_EMS_COMISSAO_SemCampObrig_Body()
        {
            IniciarTeste(TipoArquivo.Comissao, "", "FG01 - PROC5 - No Body do arquivo EMS_COMISSAO não informar valor nos seguintes campos: CD_TIPO_COMISSAO CD_COBERTURA VL_COMISSAO VL_BASE_CALCULO PC_COMISSAO PC_PARTICIPACAO CD_SISTEMA");
        ...
        [TestMethod]
        [TestCategory("Com Critica")]
        public void SAP_8154_OCR_COBRANCA_SemCampObrig_Body()
        {
            IniciarTeste(TipoArquivo.OCRCobranca, "", "FG01 - PROC5 - No Body do arquivo OCR_COBRANCA não informar valor nos seguintes campos: CD_OCORRENCIA DT_OCORRENCIA VL_PREMIO_PAGO CD_SISTEMA");
