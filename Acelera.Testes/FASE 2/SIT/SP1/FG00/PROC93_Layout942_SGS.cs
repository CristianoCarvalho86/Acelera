...
namespace Acelera.Testes.FASE_2.SIT.SP1.FG00
{
    ...
    public class PROC93_Layout942_SGS : TestesFG00
    {
        ...
        {
            IniciarTeste(TipoArquivo.Sinistro, "1193", "No Trailler do arquivo SINISTRO no campo TIPO_REGISTRO informar código 13");
        ...
        {
            IniciarTeste(TipoArquivo.Sinistro, "1187", "No Trailler do arquivo SINISTRO no campo TIPO_REGISTRO não informar valor");
