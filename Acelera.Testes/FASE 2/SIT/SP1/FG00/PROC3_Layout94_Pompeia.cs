...
namespace Acelera.Testes.FASE_2.SIT.SP1.FG00
{
    ...
    public class PROC3_Layout94_Pompeia : TestesFG00
    {
        ...
        public void SAP_1366_CLIENTE_QT_LIN_Diferente()
        {
            ...
            SalvarArquivo(ObterArquivoDestino($"C01.POMPEIA.CLIENTE-EV-/*R*/-20200228.TXT"));
        ...
        public void SAP_1368_EMS_COMISSAO_QT_LIN_Diferente()
        {
            ...
            //SALVAR O NOVO ARQUIVO ALTERADO
            SalvarArquivo(ObterArquivoDestino($"C01.POMPEIA.EMSCMS-EV-/*R*/-20200228.TXT"));
        ...
        public void SAP_1371_SINISTRO_QT_LIN_Diferente()
        {
            ...
            //SALVAR O NOVO ARQUIVO ALTERADO
            SalvarArquivo(ObterArquivoDestino($"C01.POMPEIA.SINISTRO-EV-/*R*/-20191128.TXT"));
        ...
        public void SAP_1461_SINISTRO_QT_LIN()
        {
            ...
            //SALVAR O NOVO ARQUIVO ALTERADO
            SalvarArquivo(ObterArquivoDestino($"C01.POMPEIA.SINISTRO-EV-/*R*/-20200211.TXT"));
