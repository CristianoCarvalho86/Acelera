...
namespace Acelera.Testes.FASE_2.SIT.SP1.FG00
{
    ...
    public class PROC400_Layout94_Pompeia : TestesFG00
    {
        ...
        public void SAP_1444_CLIENTE_SemNOMEARQ()
        {
            ...
            SalvarArquivo(ObterArquivoDestino($"C01.POMPEIA.CLIENTE-EV-/*R*/-20200302.TXT"));
        ...
        public void SAP_1445_PARC_EMISSAO_SemNOMEARQ()
        {
            ...
            //SALVAR O NOVO ARQUIVO ALTERADO
            SalvarArquivo(ObterArquivoDestino($"C01.POMPEIA.PARCEMS-EV-/*R*/-20200227.TXT"));
        ...
        public void SAP_1446_EMS_COMISSAO_SemNOMEARQ()
        {
            ...
            //SALVAR O NOVO ARQUIVO ALTERADO
            SalvarArquivo(ObterArquivoDestino($"C01.POMPEIA.EMSCMS-EV-/*R*/-20200229.TXT"));
