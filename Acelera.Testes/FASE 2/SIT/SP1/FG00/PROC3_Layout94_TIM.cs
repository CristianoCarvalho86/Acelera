...
namespace Acelera.Testes.FASE_2.SIT.SP1.FG00
{
    ...
    public class PROC3_Layout94_TIM : TestesFG00
    {
        ...
        public void SAP_1216_CLIENTE_QT_LIN_Diferente()
        {
            ...
            SalvarArquivo(ObterArquivoDestino($"C01.TIM.CLIENTE-EV-/*R*/-20200219.TXT"));
        ...
        public void SAP_1221_SINISTRO_QT_LIN_Diferente()
        {
            ...
            //SALVAR O NOVO ARQUIVO ALTERADO
            SalvarArquivo(ObterArquivoDestino($"C01.TIM.SINISTRO-EV-/*R*/-20200227.TXT"));
        ...
        public void SAP_1301_PARC_EMISSAO_QT_LIN()
        {
            ...
            //SALVAR O NOVO ARQUIVO ALTERADO
            SalvarArquivo(ObterArquivoDestino($"C01.TIM.PARCEMSAUTO-EV-/*R*/-20200213.TXT"));
