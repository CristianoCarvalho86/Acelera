...
namespace Acelera.Testes.FASE_2.SIT.SP1.FG00
{
    ...
    public class PROC93_Layout94_TIM : TestesFG00
    {
        ...
        public void SAP_1242_EMS_COMISSAO_TipoRegistro01()
        {
            ...
            //SALVAR O NOVO ARQUIVO ALTERADO
            SalvarArquivo(ObterArquivoDestino($"C01.TIM.EMSCMS-EV-/*R*/-20200109.TXT"));
        ...
        public void SAP_1240_CLIENTE_TipoRegistro01()
        {
            ...
            arquivo.Carregar(ObterArquivoOrigem("C01.TIM.CLIENTE-EV-0002-20200228.txt"));

            //ALTERAR O VALOR SELECIONADO
            AlterarFooter("TIPO_REGISTRO", "01");

            //SALVAR O NOVO ARQUIVO ALTERADO
            SalvarArquivo(ObterArquivoDestino($"C01.TIM.CLIENTE-EV-/*R*/-20200228.TXT"));
