...
{
    [TestClass]
    public class PROC3_Layout942_SGS : TestesFG00
    {
        /// <summary>
        ...
        {
            IniciarTeste(TipoArquivo.Sinistro, "1200", "No Trailler do arquivo SINISTRO no campo QT_LIN informar valor igual da soma de linhas do Detalhe");
