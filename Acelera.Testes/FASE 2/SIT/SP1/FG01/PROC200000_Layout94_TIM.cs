...
namespace Acelera.Testes.FASE_2.SIT.SP1.FG01
{
    ...
    public class PROC200000_Layout94_TIM : TestesFG01
    {
        ...
        public void SAP_2365_EMS_COMISSAO_SemVersao_layout()
        {
            ...
            //VALIDAR NA FG01
            ValidarLogProcessamento(true);
            ValidarStages<LinhaComissaoStage>(CodigoStage.PlanoB);
        }
        ...
        public void SAP_2366_OCR_COBRANCA_SemVersao_layout()
        {
            ...
            //VALIDAR NA FG01
            ValidarLogProcessamento(true);
            ValidarStages<LinhaOCRCobrancaStage>(CodigoStage.PlanoB);
        }
        ...
        public void SAP_2367_LANCTO_COMISSAO_SemVersao_layout()
        {
            ...
            //VALIDAR NA FG01
            ValidarLogProcessamento(true);
            ValidarStages<LinhaLanctoComissaoStage>(CodigoStage.PlanoB);
        ...
        public void SAP_2368_SINISTRO_SemVersao_layout()
        {
            ...
            //VALIDAR NA FG01
            ValidarLogProcessamento(true);
            ValidarStages<LinhaSinistroStage>(CodigoStage.PlanoB);
        }
