...
namespace Acelera.Testes.FASE_2.SIT.SP1.FG01
{
    ...
    public class PROC08_Layout942_SGS : TestesFG01
    {
        ...
        {
            IniciarTeste(TipoArquivo.Sinistro, "2390", "No Body do arquivo SINISTRO nos campos abaixo informado o código 1234567 respeitando a tamanho do campos: EN_CEP_BENEFICIARIO");
