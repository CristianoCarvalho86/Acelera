...
namespace Acelera.Testes.FASE_2.SIT.SP1.FG01
{
    ...
    public class PROC92_Layout94_Pompeia : TestesFG01
    {
        ...
        {
            IniciarTeste(TipoArquivo.Cliente, "2428", "No Header do arquivo CLIENTE no campo VERSAO informar o código 6.9");
        ...
        {
            IniciarTeste(TipoArquivo.ParcEmissao, "2429", "No Header do arquivo PARC_EMISSAO no campo VERSAO informar o código 11");
        ...
        {
            IniciarTeste(TipoArquivo.Comissao, "2430", "No Header do arquivo EMS_COMISSAO no campo VERSAO informar o código 9.6");
        ...
        {
            IniciarTeste(TipoArquivo.OCRCobranca, "2431", "No Header do arquivo OCR_COBRANCA no campo VERSAO informar o código 9.8");
        ...
        {
            IniciarTeste(TipoArquivo.LanctoComissao, "2432", " No Header do arquivo LANCTO_COMISSAO no campo VERSAO informar o código 9.9");
        ...
        {
            IniciarTeste(TipoArquivo.Sinistro, "2433", "No Header do arquivo SINISTRO no campo VERSAO informar o código 9.4");
