...
namespace Acelera.Testes
{
    ...
    public class TestesDashboard : TestesFG02
    {
        ...
        public void Teste1()
        {
            TripliceLASA triplice = new TripliceLASA(1, logger,ref valoresAlteradosBody);
            ...
            triplice.AlterarParcEComissao(0, "VL_IS", "100");
            triplice.AlterarParcEComissao(0, "VL_LMI", "100");
            //triplice.ReplicarLinhaNoParcEComissao(0, 1);

            //triplice.AlterarParcEComissao(1, "NR_PARCELA", "2");
            ...
            triplice.AlterarParcEComissao(1, "VL_IS", "200");
            triplice.AlterarParcEComissao(1, "VL_LMI", "200");
            //triplice.AlterarParcEComissao(1, "NR_APOLICE", (long.Parse(triplice.ArquivoParcEmissao.ObterLinha(1).ObterCampoDoArquivo("NR_APOLICE").ValorFormatado) + 10).ToString());
