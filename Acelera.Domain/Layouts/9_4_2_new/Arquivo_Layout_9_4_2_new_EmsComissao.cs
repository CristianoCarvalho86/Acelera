...
namespace Acelera.Domain.Layouts._9_4
{
    ...
    public class Arquivo_Layout_9_4_2_new_EmsComissao : Arquivo
    {
        ...
        protected override void CarregaCamposDoLayout(ILinhaArquivo linha)
        {
            ...
            linha.Campos.Add(new CampoDoArquivo("NR_SEQUENCIAL_EMISSAO", 10));
            ...
            linha.Campos.Add(new CampoDoArquivo("FILLER", 577));
        }
    }
}
