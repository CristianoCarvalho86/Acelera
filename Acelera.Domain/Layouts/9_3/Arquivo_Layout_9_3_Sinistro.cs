...
{
    public class Arquivo_Layout_9_3_Sinistro : Arquivo
    {
        ...
        protected override void CarregaCamposDoLayout(LinhaArquivo linha)
        {
            ...
            linha.Campos.Add(new CampoDoArquivo("NR_SEQ_EMISSAO", 5, "NR_SEQUENCIAL_EMISSAO"));
            ...
            linha.Campos.Add(new CampoDoArquivo("FILLER", 123));
