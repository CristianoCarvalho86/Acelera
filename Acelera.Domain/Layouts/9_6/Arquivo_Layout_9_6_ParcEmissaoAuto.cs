...
{
    [Serializable]
    public class Arquivo_Layout_9_6_ParcEmissaoAuto : Arquivo
    {
        ...
        protected override void CarregaCamposDoLayout(ILinhaArquivo linha)
        {
            ...
            linha.Campos.Add(new CampoDoArquivo("NR_SEQUENCIAL_EMISSAO_EST", 10));
            linha.Campos.Add(new CampoDoArquivo("FILLER", 40));
        }
    }
}
